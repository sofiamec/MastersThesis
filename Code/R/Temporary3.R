...
colnames(AUC15) <-c("Experimental Desgin (6M)", "AUC0.01", "Experimental Design (10M)","AUC0.01")
...
colnames(AUC3) <-c("Experimental Desgin (6M)", "AUC0.01", "Experimental Design (10M)","AUC0.01")
